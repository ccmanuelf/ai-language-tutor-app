...
class LearningProgress(Base):
    ...
    # Progress metrics
    skill_type = Column(String(50), nullable=False)  # vocabulary, pronunciation, conversation
    ...
    # Constraints
    __table_args__ = (
        UniqueConstraint('user_id', 'language', 'skill_type', name='uq_user_language_skill'),
...
__all__ = [
    'Base', 'User', 'Language', 'Conversation', 'ConversationMessage',
    'Document', 'LearningProgress', 'VocabularyItem', 'APIUsage',
    'UserRole', 'LanguageCode', 'ConversationRole', 'DocumentType', 'LearningStatus',
    'user_languages'
]