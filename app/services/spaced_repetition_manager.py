...
class SpacedRepetitionManager:
    ...
    def add_learning_item(
        ...
        **kwargs,
        ...
        return self.algorithm.add_learning_item(
            user_id, language_code, content, item_type, translation, **kwargs
        )
    ...
    def get_due_items(
        ...
        # Note: item_type parameter is accepted for backward compatibility but not used
        # The underlying algorithm doesn't filter by item_type yet
        return self.algorithm.get_due_items(user_id, language_code, limit)
