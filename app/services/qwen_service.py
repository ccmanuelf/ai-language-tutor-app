...
class QwenService(BaseAIService):
    ...
    def __init__(self):
        ...
        if QWEN_AVAILABLE and hasattr(self.settings, 'QWEN_API_KEY') and self.settings.QWEN_API_KEY:
            try:
    ...
    async def generate_response(
        ...
        **kwargs
        ...
        try:
            ...
            response_content = response.choices[0].message.content if response.choices else "抱歉，我无法生成回应。"
