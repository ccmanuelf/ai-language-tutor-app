...
async def comprehensive_speech_validation():
    ...
    # Test 3: TTS with Actual Audio File Generation
    print("3️⃣ TEXT-TO-SPEECH WITH AUDIO FILE VERIFICATION")
    print("-" * 50)
    ...
    for i, (phrase, language) in enumerate(test_phrases, 1):
        try:
    ...
    if success_rate >= 90 and len(validation_results["critical_issues"]) == 0:
