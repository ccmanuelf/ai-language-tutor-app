...
async def test_conversation_management():
    ...
    try:
        ...
        expected_focuses = ["conversation", "grammar", "vocabulary", "pronunciation", "reading", "writing"]
    ...
    tests_total += 1
    try:
        from app.services.conversation_manager import ConversationContext, LearningFocus
    ...
    try:
        ...
        assert "verb conjugation" in system_message or "sentence structure" in system_message
    ...
    try:
        if conversation_id in conversation_manager.active_conversations:
            ...
            assert conversation_id in conversation_manager.active_conversations  # Should still be in memory
            
            # Test resume
            resume_success = await conversation_manager.resume_conversation(conversation_id)
...
async def main():
    ...
    try:
        ...
        if success:
            ...
            print("   ✅ Learning focus areas (conversation, grammar, vocabulary, etc.)")
