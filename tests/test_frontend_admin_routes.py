...
class TestAdminRoutes:
    ...
    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_dashboard_redirect_forbidden_non_admin(
        self, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_dashboard_redirect_exception_handling(
        self, mock_auth_service, mock_get_user
    ):
    ...
    def test_admin_users_page_success(
        self, mock_guest_manager, mock_db_context, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.get_db_session_context")
    @patch("app.services.admin_auth.GuestUserManager")
    def test_admin_users_page_without_guest_session(
        self, mock_guest_manager, mock_db_context, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_users_page_forbidden_non_admin(
        self, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.admin_auth_service")
    @patch("app.frontend.admin_routes.get_db_session_context")
    def test_admin_users_page_exception_handling(
        self, mock_db_context, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.layout.create_admin_header")
    @patch("app.frontend.layout.create_admin_sidebar")
    def test_admin_languages_page_success(
        self,
        mock_sidebar,
        mock_header,
        mock_permission,
        ...
        """Test admin languages page loads successfully"""
        mock_get_user.return_value = self.mock_admin_user
        mock_auth_service.is_admin_user.return_value = True
        ...
        assert response.status_code == 200
        content = response.text
        assert "Language Configuration" in content

    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_languages_page_forbidden_non_admin(
        self, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.admin_auth_service")
    @patch("app.frontend.admin_routes.AdminPermission")
    def test_admin_languages_page_forbidden_no_permission(
    ...
    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_languages_page_exception_handling(
        self, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.layout.create_admin_header")
    @patch("app.frontend.layout.create_admin_sidebar")
    def test_admin_features_page_success(
        self,
        mock_sidebar,
        mock_header,
        mock_permission,
        ...
        """Test admin features page loads successfully"""
        mock_get_user.return_value = self.mock_admin_user
        mock_auth_service.is_admin_user.return_value = True
        mock_auth_service.has_permission.return_value = True
        mock_header.return_value = "HEADER"
    ...
    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_features_page_forbidden_non_admin(
        self, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.admin_auth_service")
    @patch("app.frontend.admin_routes.AdminPermission")
    def test_admin_features_page_forbidden_no_permission(
        self, mock_permission, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_features_page_exception_handling(
        self, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.admin_auth_service")
    @patch("app.frontend.admin_routes.AdminPermission")
    def test_admin_ai_models_page_success(
        self, mock_permission, mock_auth_service, mock_get_user
    ):
        """Test admin AI models page loads successfully"""
        mock_get_user.return_value = self.mock_admin_user
        mock_auth_service.is_admin_user.return_value = True
        mock_auth_service.has_permission.return_value = True
        ...
        assert response.status_code == 200
        content = response.text
        assert "AI Model Management" in content

    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_ai_models_page_forbidden_non_admin(
        self, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.admin_auth_service")
    @patch("app.frontend.admin_routes.AdminPermission")
    def test_admin_ai_models_page_forbidden_no_permission(
        self, mock_permission, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_ai_models_page_exception_handling(
        self, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_system_page_forbidden_non_admin(
        self, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_system_page_exception_handling(
        self, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.layout.create_admin_header")
    @patch("app.frontend.layout.create_admin_sidebar")
    def test_admin_scenarios_page_success(
        self,
        mock_sidebar,
        mock_header,
        mock_permission,
        ...
        """Test admin scenarios page loads successfully"""
        mock_get_user.return_value = self.mock_admin_user
        mock_auth_service.is_admin_user.return_value = True
        mock_auth_service.has_permission.return_value = True
        mock_header.return_value = "HEADER"
        ...
        assert response.status_code == 200
        content = response.text
        assert "Scenario" in content and "Content Management" in content

    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_scenarios_page_forbidden_non_admin(
        self, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.admin_auth_service")
    @patch("app.frontend.admin_routes.AdminPermission")
    def test_admin_scenarios_page_forbidden_no_permission(
        self, mock_permission, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_scenarios_page_exception_handling(
        self, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.layout.create_admin_header")
    @patch("app.frontend.layout.create_admin_sidebar")
    @patch("app.frontend.admin_routes.progress_analytics_dashboard_page")
    def test_admin_progress_analytics_page_success(
        self,
        mock_dashboard,
        mock_sidebar,
        mock_header,
        ...
        """Test admin progress analytics page loads successfully"""
        mock_get_user.return_value = self.mock_admin_user
        mock_auth_service.is_admin_user.return_value = True
        mock_auth_service.has_permission.return_value = True
        mock_header.return_value = "HEADER"
        ...
        assert response.status_code == 200
        content = response.text
        assert "Progress Analytics" in content

    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_progress_analytics_page_forbidden_non_admin(
        self, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.admin_auth_service")
    @patch("app.frontend.admin_routes.AdminPermission")
    def test_admin_progress_analytics_page_forbidden_no_permission(
        self, mock_permission, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_progress_analytics_page_exception_handling(
        self, mock_auth_service, mock_get_user
    ):
    ...
    def test_register_admin_routes_logging(self, mock_logger):
        ...
        mock_logger.info.assert_called_once_with(
            "Admin dashboard routes registered successfully"
        )
...
class TestAdminRoutesHTTPExceptions:
    ...
    @patch("app.frontend.admin_routes.get_db_session_context")
    @patch("app.services.admin_auth.GuestUserManager")
    def test_admin_users_page_reraises_http_exception(
        self, mock_guest_manager, mock_db_context, mock_auth_service, mock_get_user
    ):
        ...
        mock_session = MagicMock()
        mock_db_context.return_value.__enter__.return_value = mock_session
        mock_session.query.side_effect = HTTPException(
    ...
    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_languages_page_reraises_http_exception(
        self, mock_auth_service, mock_get_user
    ):
        ...
        mock_auth_service.is_admin_user.side_effect = HTTPException(
    ...
    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_features_page_reraises_http_exception(
        self, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_ai_models_page_reraises_http_exception(
        self, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_scenarios_page_reraises_http_exception(
        self, mock_auth_service, mock_get_user
    ):
    ...
    @patch("app.frontend.admin_routes.get_current_user")
    @patch("app.frontend.admin_routes.admin_auth_service")
    def test_admin_progress_analytics_page_reraises_http_exception(
        self, mock_auth_service, mock_get_user
    ):
...
# TestAdminRoutesImportErrors class removed - bug fixed in Session 116
# Previously tested for missing get_admin_styles() import which has been corrected to load_styles()
