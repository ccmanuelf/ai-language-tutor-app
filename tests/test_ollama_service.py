...
class TestGetHealthStatus:
    ...
    async def test_get_health_status_error(self):
        ...
        with patch.object(service, 'check_availability', side_effect=Exception("Network error")):
            status = await service.get_health_status()
...
class TestOllamaManager:
    ...
    async def test_check_installation_not_installed(self):
        ...
        with patch.object(manager.service, 'get_health_status', return_value=mock_status):
...
class TestConvenienceFunctions:
    ...
    async def test_get_ollama_status(self):
        ...
        with patch.object(ollama_service, 'get_health_status', return_value=mock_status):
    ...
    async def test_generate_local_response(self):
        ...
        with patch.object(ollama_service, 'generate_response', return_value=mock_response):
    ...
    async def test_setup_ollama_for_language_learning(self):
        ...
        with patch.object(ollama_manager, 'setup_for_language_learning', return_value=mock_result):
